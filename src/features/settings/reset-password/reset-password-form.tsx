                    ...
                    <div className="space-y-2">
                        ...
                        {password && (
                            <div className="space-y-2">
                                ...
                                <p className={`text-sm ${passwordStrength <= 2 ? 'text-red-600' :
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg">
                        ...
                        <ul className="text-xs text-gray-600 space-y-1">
                            <li className={`flex items-center ${password.length >= 8 ? 'text-green-600' : ''}`}>
                                <div className={`w-1.5 h-1.5 rounded-full mr-2 ${password.length >= 8 ? 'bg-green-500' : 'bg-gray-300'}`} />
                                At least 8 characters
                            </li>
                            <li className={`flex items-center ${/[A-Z]/.test(password) ? 'text-green-600' : ''}`}>
                                <div className={`w-1.5 h-1.5 rounded-full mr-2 ${/[A-Z]/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`} />
                            ...
                            <li className={`flex items-center ${/\d/.test(password) ? 'text-green-600' : ''}`}>
                                <div className={`w-1.5 h-1.5 rounded-full mr-2 ${/\d/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`} />
                                One number
                            </li>
                            <li className={`flex items-center ${/[@$!%*?&]/.test(password) ? 'text-green-600' : ''}`}>
                                <div className={`w-1.5 h-1.5 rounded-full mr-2 ${/[@$!%*?&]/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`} />
