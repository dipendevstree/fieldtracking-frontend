...
export function ApproversActionModal() {
  ...
  useEffect(() => {
    ...
    isCreateHierarchySuccess,
    isCreateHierarchyError,
    // isUpdateHierarchySuccess,
    // isUpdateHierarchyError,
    isDeleteHierarchySuccess,
    isDeleteHierarchyError,
  ...
  const handleCreateCategoryApprover = (
    values: TCategoryApproverFormSchema
  ) => {
    try {
  ...
  const handleUpdateCategoryApprover = (
    values: TCategoryApproverFormSchema
  ) => {
    try {
