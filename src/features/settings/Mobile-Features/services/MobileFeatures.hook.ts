...
import {
  ...
  MobilePermission,
  MobileFeatureSettings,
} from "../type/type";

const MOBILE_FEATURES_QUERY = "";
...
export const useDeleteMobilePermission = (
  ...
  return useDeleteData({
    url: id
      ? `mobile-features/permissions/delete/${id}`
      : "mobile-features/permissions/delete",
    refetchQueries: [MOBILE_FEATURES_QUERY],
    onSuccess: () => {
...
export const useUpdateMobileFeatureSettings = (
  id: string,
  onSuccess?: () => void
) => {
  return usePatchData<
...
export const useDeleteMobileFeatureSettings = (
  id: string,
  onSuccess?: () => void
) => {
  return useDeleteData({
    url: id
      ? `mobile-features/settings/delete/${id}`
      : "mobile-features/settings/delete",
    refetchQueries: [MOBILE_FEATURES_QUERY],
    onSuccess: () => {
      if (onSuccess && id) onSuccess();
    },
