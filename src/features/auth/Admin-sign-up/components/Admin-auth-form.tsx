  ...
  return (
    <Card>
      {isLoading ? (
        ...
        <CardContent className="px-8 py-4 overflow-auto max-h-[80vh]">
          <div className="mb-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      {watch("password") && (
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              {checkPasswordStrength(watch("password")).label}
                            </span>
                          </div>
                    ...
                    render={({ field }) => {
                      ...
                      return (
                        ...
                        >
                          <SelectTrigger
                            className={`mt-1 w-full ${
                              getFieldError("timeZone") ? "border-red-500" : ""
                            }`}
                          >
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select
                            value={field.value}
                            onValueChange={field.onChange}
                            disabled={!watchedCountry || states.length === 0} // <-- ADD: Disable if no country selected
                          >
                            <SelectTrigger
            ...
            {currentStep === 4 && (
              <div className="space-y-8">
                ...
                <div className="rounded-md bg-gray-100 p-4">
                  ...
                  <div className="grid grid-cols-1 gap-x-4 gap-y-2 text-sm text-gray-700 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      {department.find((d) => d.value === watch("department"))
                        ?.label || "-"}
                    </div>
                    <div>
                      <strong>Type:</strong>{" "}
                ...
                <div className="rounded-md bg-gray-100 p-4">
                  <h3 className="mb-2 text-lg font-semibold">Admin Contact</h3>
                  <div className="grid grid-cols-1 gap-x-4 gap-y-2 text-sm text-gray-700 md:grid-cols-2">
                    <div>
                ...
                <div className="rounded-md bg-gray-100 p-4">
                  ...
                  <div className="grid grid-cols-1 gap-x-4 gap-y-2 text-sm text-gray-700 md:grid-cols-2">
                    <div>
                      <strong>Street Address:</strong> {watch("streetAddress")}
                    </div>
                    <div>
                    ...
                    <div>
                      <strong>ZIP/Postal Code:</strong> {watch("postalCode")}
                    </div>
                    <div>
