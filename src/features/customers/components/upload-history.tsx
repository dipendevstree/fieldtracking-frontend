...
export default function UploadHistory() {
  ...
  const [loading] = useState(false); // Can be linked to API state
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track your bulk customer import history and status.
          </CardDescription>
        </CardHeader>
            ...
            >
              ...
              >
                <TableRow style={{ borderRadius: 12 }}>
                  ...
                  <TableHead style={{ fontWeight: 600, background: "#f9fafb" }}>
                    Upload Date
                  </TableHead>
                  <TableHead style={{ fontWeight: 600, background: "#f9fafb" }}>
                    Records
              ...
              <TableBody>
                {loading ? (
                  <TableLoader columnsLength={6} />
                ) : recentUploads.filter((upload) =>
                    upload.fileName
                      .toLowerCase()
