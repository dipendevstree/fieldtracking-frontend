...
const feedbackReportData: FeedbackReportData[] = [
  {
    ...
    feedback: "Wade Warren",
    date: "12-02-2025",
    productivity: "100%",
  },
  {
    salesRep: "Floyd Miles",
    feedback: "Albert Flores",
    date: "01-05-2025",
    productivity: "100%",
  },
  {
    salesRep: "Eleanor Pena",
    feedback: "Courtney Henry",
    date: "21-09-2025",
    productivity: "100%",
  },
  {
...
const quickStatsData2: QuickStatsData2[] = [
  {
    topPerformer: "Kristin Watson",
    topProductive: "Wade Warren",
    topFeedback: "Dianne Russell",
  },
  {
    topPerformer: "Floyd Miles",
    topProductive: "Albert Flores",
    topFeedback: "Ronald Richards",
  },
  {
    topPerformer: "Eleanor Pena",
    topProductive: "Courtney Henry",
    topFeedback: "Jerome Bell",
  },
];
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("salesRep")}</span>
        ),
        enableSorting: false,
      },
      {
        ...
        header: () => (
          <span className="font-medium text-gray-600">Feedback Report</span>
        ),
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("feedback")}</span>
        ),
        enableSorting: false,
      },
      {
      ...
      },
      {
        ...
        header: () => (
          <span className="font-medium text-gray-600">Productivity Report</span>
        ),
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("productivity")}</span>
        ),
        enableSorting: false,
      },
    ],
    ...
    () => [
      {
        ...
        header: () => (
          <span className="font-medium text-gray-600">
            Top Performer Sales Rep
          </span>
        ),
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("topPerformer")}</span>
        ),
      },
      {
        ...
        header: () => (
          <span className="font-medium text-gray-600">
            Top Productive Sales Rep
          </span>
        ),
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("topProductive")}</span>
        ),
      },
      {
        ...
        header: () => (
          <span className="font-medium text-gray-600">
            Top Feedback Gainers
          </span>
        ),
        cell: ({ row }) => (
          <span className="text-sm">{row.getValue("topFeedback")}</span>
        ),
      },
    ],
    [],
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">
          Generate detailed expense reports with customizable filters.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure your performance report parameters
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {salesRepsLoading ? (
                  <TableLoader columnsLength={quickStats2Columns.length} />
                ) : quickStats2Table.getRowModel().rows.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={quickStats2Columns.length}
