  ...
  const handleOpenAutoFocus = React.useCallback(
    (event: Event) => {
      ...
      for (const element of focusableElements) {
        // Skip elements that are hidden or have aria-hidden
        if (
        ...
        // Skip the close button (usually has specific class or is at the end)
        if (element.closest('[data-slot="dialog-close"]')) {
          continue;
        }
